export default function MediaPlaceholder({ label, compact = false }: { label: string; compact?: boolean }) {
  return (
    <div
      className={`relative w-full rounded-2xl bg-gradient-to-br from-base-800 to-base-900 border border-base-800 flex items-center justify-center overflow-hidden ${
        compact ? 'h-28' : 'h-48'
      }`}
    >
      ...
      <div className="relative flex flex-col items-center gap-2 text-base-400">
