...
export const exercises: Exercise[] = [
  // ---------- PUSH ----------
  ex('press-banca-barra', 'Press banca con barra', ['pecho', 'triceps', 'hombro'], 'Empuje horizontal', 'barbell', 'compound-main', ['press-plano-mancuernas', 'press-pecho-maquina', 'press-banca-smith']),
  ex('press-plano-mancuernas', 'Press plano con mancuernas', ['pecho', 'triceps', 'hombro'], 'Empuje horizontal', 'dumbbell', 'compound-main', ['press-banca-barra', 'press-pecho-maquina', 'press-banca-smith']),
  ex('press-pecho-maquina', 'Press pecho máquina', ['pecho', 'triceps'], 'Empuje horizontal', 'machine', 'compound-main', ['press-banca-barra', 'press-plano-mancuernas', 'press-banca-smith']),
  ex('press-banca-smith', 'Press banca en Smith', ['pecho', 'triceps', 'hombro'], 'Empuje horizontal', 'smith', 'compound-main', ['press-banca-barra', 'press-plano-mancuernas', 'press-pecho-maquina']),
  ...
  ex('press-militar-mancuernas', 'Press militar sentado con mancuernas', ['hombro', 'triceps'], 'Empuje vertical', 'dumbbell', 'compound-secondary', ['press-hombro-maquina', 'press-militar-barra', 'press-militar-smith']),
  ex('press-hombro-maquina', 'Press hombro máquina', ['hombro', 'triceps'], 'Empuje vertical', 'machine', 'compound-secondary', ['press-militar-mancuernas', 'press-militar-barra', 'press-militar-smith']),
  ex('press-militar-barra', 'Press militar con barra', ['hombro', 'triceps'], 'Empuje vertical', 'barbell', 'compound-secondary', ['press-militar-mancuernas', 'press-hombro-maquina', 'press-militar-smith']),
  ex('press-militar-smith', 'Press militar en Smith', ['hombro', 'triceps'], 'Empuje vertical', 'smith', 'compound-secondary', ['press-militar-mancuernas', 'press-hombro-maquina', 'press-militar-barra']),
  ...
  ex('elevacion-frontal-mancuernas', 'Elevación frontal con mancuernas', ['hombro'], 'Flexión de hombro', 'dumbbell', 'isolation', ['elevacion-frontal-disco', 'elevacion-frontal-polea']),
  ex('elevacion-frontal-disco', 'Elevación frontal con disco', ['hombro'], 'Flexión de hombro', 'plate', 'isolation', ['elevacion-frontal-mancuernas', 'elevacion-frontal-polea']),
  ex('elevacion-frontal-polea', 'Elevación frontal en polea', ['hombro'], 'Flexión de hombro', 'cable', 'isolation', ['elevacion-frontal-mancuernas', 'elevacion-frontal-disco']),
  ...
  ex('remo-t', 'Remo T con pecho apoyado', ['espalda', 'biceps'], 'Tracción horizontal', 'machine', 'compound-main', ['remo-maquina', 'remo-polea', 'remo-barra']),
  ...
  ex('sentadilla-smith', 'Sentadilla en Smith', ['cuadriceps', 'gluteo'], 'Sentadilla', 'smith', 'compound-main', ['sentadilla', 'hack-squat', 'prensa'], { comparisonGroup: 'rodilla-dominante' }),
  ex('sentadilla-goblet', 'Sentadilla goblet con mancuerna', ['cuadriceps', 'gluteo'], 'Sentadilla', 'dumbbell', 'compound-main', ['sentadilla', 'hack-squat'], { comparisonGroup: 'rodilla-dominante' }),
  ...
  ex('peso-muerto-convencional', 'Peso muerto convencional', ['isquios', 'gluteo', 'espalda'], 'Bisagra de cadera', 'barbell', 'compound-main', ['peso-muerto-rumano']),
...
export function getExercise(id: string): Exercise | undefined {
  return exerciseMap[id] ?? listCustomExercises().find((e) => e.id === id)
}

// Biblioteca curada + ejercicios que el propio usuario ha creado — para
// buscadores/selectores donde ambos deben aparecer mezclados.
export function getAllExercises(): Exercise[] {
  return [...exercises, ...listCustomExercises()]
}
